	...
	<footer class="col-xs-12 backgroundimg">
			<div class="footer-space"></div>
				...
				<div class="footerItemList">
					...
					<ul>
						<li><a class="header-a" href=""><h3 class="header-h3">聯絡我們</h3></a></li>
						<li><a class="header-a" href=""><h3 class="header-h3">03-4257387</h3></a></li>
						<li><a class="header-a" href=""><h3 class="header-h3">320 桃園市中壢區中大路300號</h3></a></li>
					</ul>
			  </div>
